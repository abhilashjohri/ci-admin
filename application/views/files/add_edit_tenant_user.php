    <div class="page-content-wrapper">
        <div class="page-content">              
            <!-- BEGIN PAGE HEADER-->
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Add Tenant User 
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                            ...
                            <form role="form" action="" method="post" class="form-horizontal form-row-seperated">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group <?php if(form_error('group_admin_id')!=''){ echo 'has-error'; }; ?>" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="form-control" name="group_admin_id" id="group_admin_id" >
                                                    ...
                                                    <?php } ?>
                                                    <?php if($this->user->role_id <= 2){ ?>
                                                    <div class="form-group <?php if(form_error('tenant_admin_id')!=''){ echo 'has-error'; }; ?>" >
                                                        <label class="control-label col-md-3">Tenant Admin Name</label>
                                                        <div class="col-md-9">
                                                            <select class="form-control" name="tenant_admin_id" id="tenant_admin_id" >
                                                                <option value=''>Select Tenant Admin</option>
                                                                <?php if(count($tenantAdminData)>0){ 
                                                                        for($i=0;$i<count($tenantAdminData);$i++){ ?>
                                                                            <option <?php if($tenantAdminData[$i]->user_id == $tenantAdminId){ echo 'selected'; } ?> value="<?php echo $tenantAdminData[$i]->user_id; ?>" ><?php echo $tenantAdminData[$i]->name.' - '.$tenantAdminData[$i]->email; ?></option>
                                                                <?php  }
                                                                ?>
                                                                <?php } ?>
                                                            </select>
                                                            <?php echo form_error('tenant_admin_id'); ?>
                                                        </div>
                                                    </div>
                                                    <?php } ?>
                                                    ...
                                                    <!-- <div class="form-group <?php if(form_error('preference')!=''){ echo 'has-error'; }; ?>">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" placeholder="Default Preference" class="form-control" name="preference" value="<?php echo set_value('preference'); ?>" /> 
                                                     ...
                                                     <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <input type="submit" name="add_tenant_user" value=" Add Tenant User " class="btn green" />
                                                                <a href="<?php echo site_url("users/tenant_user_list"); ?>" class="btn default"> Cancel </a>
                                                            </div>
                                                        </div>
                                                    </div>
